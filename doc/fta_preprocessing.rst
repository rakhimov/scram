...
transformations of propositional directed acyclic graphs (PDAG)
...
This procedure transforms the graph into negation normal form
...
corresponding to the distributivity of *AND* and *OR* operators.
...
can be merged into a new gate with the same logic as the group.
...
and noting the failure destinations.
