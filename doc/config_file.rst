...
command-line arguments. Moreover, additional command-line options can
be provided to overwrite or suppress the options from a configuration file.

The configuration file is an XML file that must conform
to the specific schema provided bellow.
