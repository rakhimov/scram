...
be provided to override or suppress the options from a configuration file.

The configuration file is an XML file that must conform to the specific schema
provided bellow.
